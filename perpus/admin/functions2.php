...
function ubah($data){
	...
	$gambarlama = htmlspecialchars($data["gambarlama"]);
		...
		$query = "UPDATE produk SET nama_makanan = '$nama_makanan',deskripsi_makanan='$deskripsi_makanan',asal_makanan=$'asal_makanan',bahan_makanan='$bahan_makanan',gambar_makanan='$gambar_makanan' WHERE id_makanan = $id_makanan";
